...
export class ProductDetailsComponent {
  ...
  // ngOnInit(){
  //   console.log();
  //   console.log(this.products.find(product=> product.id === Number(this.id)));
    
  // }
  product: any = {}; // Store the found product

  ngOnInit() {
    // Find the product based on the ID
    const foundProduct = this.products.find(product => product.id === Number(this.id));
